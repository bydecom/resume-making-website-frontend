...
const ResumeAssesment = ({ assessment }) => {
  ...
  return (
    <div className="space-y-4">
      <div className="border rounded-lg p-4 shadow-sm">
        <h3 className="text-lg font-semibold mb-2">Resume Assessment</h3>
        <div className="mb-4">
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
        <p className="text-sm text-gray-700">
          Are you sure you want to save this Resume? You can always edit it later.
        </p>
      </div>
    </div>
  );
...
export default ResumeAssesment; 