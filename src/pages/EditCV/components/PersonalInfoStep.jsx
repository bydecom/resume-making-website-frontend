...
const PersonalInfoStep = ({ data, updateData, nextStep, externalErrors }) => {
  ...
  const validate = () => {
    ...
    if (!localData.professionalHeadline?.trim()) newErrors.professionalHeadline = 'Professional headline is required';
  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          <label className="block text-gray-700 font-semibold mb-2" htmlFor="professionalHeadline">
          ...
          <input
            ...
            value={localData.professionalHeadline || ''}
            onChange={handleChange}
            className={`w-full px-3 py-2 border ${errors.professionalHeadline ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500`}
            placeholder="e.g., Senior Software Engineer with 5+ years of experience"
          />
          {errors.professionalHeadline && <p className="text-red-500 text-sm mt-1">{errors.professionalHeadline}</p>}
